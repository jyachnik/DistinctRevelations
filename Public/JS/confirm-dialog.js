...
(function () {
  function ensureDom() {
    ...
    overlay.className = 'dr-confirm-overlay';
    overlay.setAttribute('aria-hidden', 'true');
    overlay.innerHTML =
      '<div class="dr-confirm-box" role="alertdialog" aria-modal="true" aria-labelledby="drConfirmTitle" aria-describedby="drConfirmMsg">' +
        '<div class="dr-confirm-accent"></div>' +
        '<h3 id="drConfirmTitle" class="dr-confirm-title"></h3>' +
  ...
  function drConfirm(message, opts) {
    ...
    return new Promise(function (resolve) {
      ...
      var titleEl = overlay.querySelector('.dr-confirm-title');
